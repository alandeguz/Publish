...
<p align="center">
    ...
    <a href="https://swift.org/package-manager">
     ...
     <img src="https://img.shields.io/badge/platform-macOS-brightgreen.svg?style=flat" alt="macOS" />
</p>
...
This project is a fork of the original upstream [Publish](https://github.com/JohnSundell/Publish). 
...
To use Publish, make sure that your system has Swift 6.2 or later installed. Also make sure that `xcode-select` points to an Xcode installation that includes the required version of Swift, and that you’re running macOS 12 or later.
...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/johnsundell/publish.git", from: "0.9.8")
    ],
    ...
)
```
